...
## Contents
* [我的HeapSort程式碼](https://github.com/chinghsuan/class_exercises/blob/master/HW2/heap_sort_06170203.py)
* [我的MergeSort程式碼](https://github.com/chinghsuan/class_exercises/blob/master/HW2/merge_sort_06170203.py)
...
關於我的一些想法：
1. 理論上，MergeSort應該還是比HeapSort來得快速，雖然兩者的Worst complexity都為O(nlogn)，但是HeapSort是in-place的排序法，不需要像MergeSort每次都要跟記憶體求取一塊位置暫存，所以整理來說，HeapSort在某些情況下，還是比MergeSort來得好的。  
2. n 愈大，MergeSort所需的暫存空間就愈多，額外的空間需求也與 n 成正比，效能也會與heapsort越有顯著差別。
